 ...
 *********************************************************************************************************************/
	...
	VAR(boolean, AUTOMATIC) T1vsT2Active_Cnt_T_lgc;
	VAR(boolean, AUTOMATIC) T1OutofRangeActive_Cnt_T_lgc;
	VAR(boolean, AUTOMATIC) T2OutofRangeActive_Cnt_T_lgc;
	VAR(boolean, AUTOMATIC) TrqSensorNotTrimmedActive_Cnt_T_lgc;
	...
	if (TRUE == k_LKAMfgEnable_Cnt_lgc)
	{
		...
		/* Check for a "torque sensor fault" per existing K2xx requirements. */
		(void)Rte_Call_NxtrDiagMgr_GetNTCActive(NTC_Num_T1vsT2, &T1vsT2Active_Cnt_T_lgc);                                   /* NTC 0x065 */
		(void)Rte_Call_NxtrDiagMgr_GetNTCActive(NTC_Num_T1OutofRange, &T1OutofRangeActive_Cnt_T_lgc);                       /* NTC 0x066 */
		(void)Rte_Call_NxtrDiagMgr_GetNTCActive(NTC_Num_T2OutofRange, &T2OutofRangeActive_Cnt_T_lgc);                       /* NTC 0x067 */
		(void)Rte_Call_NxtrDiagMgr_GetNTCActive(NTC_Num_TrqSensorNotTrimmed, &TrqSensorNotTrimmedActive_Cnt_T_lgc);         /* NTC 0x1FB */

		if ((TRUE == T1vsT2Active_Cnt_T_lgc) ||
			(TRUE == T1OutofRangeActive_Cnt_T_lgc) ||
			(TRUE == T2OutofRangeActive_Cnt_T_lgc) ||
			(TRUE == TrqSensorNotTrimmedActive_Cnt_T_lgc))
		{

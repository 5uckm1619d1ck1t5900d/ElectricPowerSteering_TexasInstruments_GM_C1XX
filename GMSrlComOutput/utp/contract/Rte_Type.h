...
{
  /* PIM Handles section */
  P2VAR(DTCStsFlg, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_DTCTrigSts;
...
#    error "The magic number of the generated file <C:/02_EA3Int/C1xx/Wip_fz9hxm/GMSrlComOutput/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

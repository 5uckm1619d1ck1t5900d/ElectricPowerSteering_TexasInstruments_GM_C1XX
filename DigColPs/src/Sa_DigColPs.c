 ...
 *  Generated at:  Thu Jun  2 11:37:48 2016
 *
...
STATIC VAR(uint16,AP_DIGCOLPS_VAR) DigColPs_I2CHwCustData_Uls_M_u16;
...
STATIC VAR(boolean,AP_DIGCOLPS_VAR) DigColPs_I2CHwCustDataReadComplete_Cnt_M_lgc;
...
#include "MemMap.h" /* PRQA S 5087 */
STATIC CONST(sint16, AP_DIGCOLPS_CONST) T2_ColSpurVernierLUT_Cnt_s16[4][D_COLSPURTBLXSIZE_CNT_U08] = {                                                    /* PRQA S 3218 */
 ...
 *********************************************************************************************************************/
	...
	DigColPs_I2CHwCustDataReadComplete_Cnt_M_lgc = FALSE;
 ...
 *********************************************************************************************************************/
	...
	/* Cust Data Read Once */
	if(DigColPs_I2CHwCustDataReadComplete_Cnt_M_lgc == FALSE)
	{
		DigColPs_I2CHwCustData_Uls_M_u16 = DigColPsInt_GetCustData();
		if(DigColPs_I2CHwCustData_Uls_M_u16 != D_I2CHWCUSTDATAUNKWN_CNT_U16)
		{
			DigColPs_I2CHwCustDataReadComplete_Cnt_M_lgc = TRUE;
		}
	}
 ...
 *********************************************************************************************************************/
	...
	I2CHwCustData_Uls_T_u16 = DigColPs_I2CHwCustData_Uls_M_u16;
	...
	if(DigColPs_SnsrReInitInProgs_Cnt_M_lgc == FALSE)
	{
		if(SnsrSampleOk_Cnt_T_lgc == TRUE)
		{
			...
			if (DigColPs_I2CHwCustData_Uls_M_u16 == D_I2CHWDUALSPURSENSOR_CNT_U16)
			{

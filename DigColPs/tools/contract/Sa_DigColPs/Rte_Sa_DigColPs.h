 ...
 *  Generated at:  Thu Jun  2 11:37:55 2016
 *
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_Sa_DigColPs_SystemTime_DtrmnElapsedTime_mS_u16(UInt32 InitialTime, P2VAR(UInt16, AUTOMATIC, RTE_SA_DIGCOLPS_APPL_VAR) ElapsedTime);
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_Sa_DigColPs_SystemTime_GetSystemTime_mS_u32(P2VAR(UInt32, AUTOMATIC, RTE_SA_DIGCOLPS_APPL_VAR) CurrentTime);
...
# define Rte_Call_SystemTime_DtrmnElapsedTime_mS_u16 Rte_Call_Sa_DigColPs_SystemTime_DtrmnElapsedTime_mS_u16
# define Rte_Call_SystemTime_GetSystemTime_mS_u32 Rte_Call_Sa_DigColPs_SystemTime_GetSystemTime_mS_u32
...
#   if RTE_MAGIC_NUMBER != 1464878590
#    error "The magic number of the generated file <C:/SynergyWorkArea/Working/DigColPs/tools/contract/Sa_DigColPs/Rte_Sa_DigColPs.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1464878590

...
#    error "The magic number of the generated file <C:/SynergyWorkArea/Working/DigColPs/tools/contract/Sa_DigColPs/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

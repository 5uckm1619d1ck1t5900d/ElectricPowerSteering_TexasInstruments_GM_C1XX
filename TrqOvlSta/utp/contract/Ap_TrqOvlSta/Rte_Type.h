...
struct Rte_CDS_Ap_TrqOvlSta
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_APADrvrInterventionDetected_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_APANonRecoverableFaults_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_APARecoverableFaults_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_APARequest_Cnt_lgc;
  P2VAR(Rte_DE_APA_State_enum, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_APAState_State_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_CCWPosition_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_CWPosition_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_ESCFault_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_ESCIsLimited_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_ESCRequest_Cnt_lgc;
  P2VAR(Rte_DE_ESC_State_enum, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_ESCState_State_enum;
  P2VAR(Rte_DE_Haptic_State_enum, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_GMOSHOscillateState_State_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_GMOSH_APAMfgEnable_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_GMOSH_ESCMfgEnable_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_GMOSH_LKAMfgEnable_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_HapticRequest_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_LKAFault_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_LKAInhibit_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_LKARequest_Cnt_lgc;
  P2VAR(Rte_DE_LKA_State_enum, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_LKAState_State_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_MaxSecureVehicleSpeed_Kph_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_MinSecureVehicleSpeed_Kph_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_PosServEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_PosSrvoHwAngle_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_PosTrajEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_PosTrajHwAngle_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_SWARTrgtAngRequest_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_ShiftLeverIsInReverse_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_TrqOscAmp_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_TrqOscEnable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TRQOVLSTA_APPL_VAR) TrqOvlSta_Per1_TrqOscFreq_Hz_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_TrqOvlSta, RTE_CONST, RTE_CONST) Rte_Inst_Ap_TrqOvlSta;
...
#    error "The magic number of the generated file <C:/Sankar/Synergy/Working/TrqOvlSta-pznywf/TrqOvlSta/utp/contract/Ap_TrqOvlSta/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

...
struct Rte_CDS_Ap_CustPerSrvcs
{
  /* Data Handles section */
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_CUSTPERSRVCS_APPL_VAR) CustPerSrvcs_Per1_ThermalLimitFlagCntr_Cnt_u08;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_CustPerSrvcs, RTE_CONST, RTE_CONST) Rte_Inst_Ap_CustPerSrvcs;
...
#    error "The magic number of the generated file <C:/Synergy/GM_C1XX_EPS_TMS570-zz4r1x/GM_C1XX_EPS_TMS570/SwProject/CustPerSrvcs/utp/contract/Ap_CustPerSrvcs/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

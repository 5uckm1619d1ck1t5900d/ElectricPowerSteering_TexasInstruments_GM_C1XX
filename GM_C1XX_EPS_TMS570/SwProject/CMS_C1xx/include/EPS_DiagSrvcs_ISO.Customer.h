 ...
 * --------  -------  --------  ---------------------------------------------------------------------------  ----------
 * 07/29/13  1        LWW       Initial C1xx Synergy Version                                                 8766
 * 09/12/13  2        LWW       Added new customer specific nexteer services
 * 09/30/13  3        LWW       Updates per new CMS configuration
 * 11/20/14  4        JWJ       Moved XCP PID 0xFF over to common configuration                              12661
 * 01/26/15  5        JWJ       Cyber security updates                                                          12851
 */
/***********************************************************************************************************************
...
#define	D_DIAGSRCVS_PROGPIDTBLSIZE_CNT_U16	19U

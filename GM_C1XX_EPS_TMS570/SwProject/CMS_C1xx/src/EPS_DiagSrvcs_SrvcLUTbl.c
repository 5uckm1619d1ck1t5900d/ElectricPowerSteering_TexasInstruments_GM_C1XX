 ...
 * %version:          EA3#12 %
 * %derived_by:       fz9hxm %
 * %date_modified:    Fri Oct 25 09:40:00 2013 %
 * --------------------------------------------------------------------------------------------------------------------
 * Date      Rev      Author    Change Description                                                           SCR #
 * --------  -------  --------  ---------------------------------------------------------------------------  ----------
 * 07/29/13  1        LWW       Initial C1xx Synergy Version                                                    8766
 * 08/30/13  2        LWW       Manual updates for DigMSB calibration
 * 09/12/13  3        LWW       Added new customer specific nexteer services
 * 09/30/13  4        LWW       Updates per new CMS configuration
 * 10/25/13  5        BWL       Updates per new CMS Generator
 * 11/20/14  7        JWJ       Implemented XCP as per DSR rev 001H                                             12661
 * 01/26/15  8        JWJ       Cyber security updates                                                          12851
 * 04/12/16  9        CP        Integrated CMS_Common_10B.1 and added CM_CyberSecNexteerLocked_Cnt_lgc to
 *                              Fix anomaly EA3#2978                                                            5491
 * 05/21/16  10        CP        Integrated CMS_Common_10C.0 to fix EA3#5733, EA3#5805
 */
/***********************************************************************************************************************

 ...
 *  Generated at:  Wed Apr  9 14:32:45 2014
 *
 ...
 * -------   -------      --------  ---------------------------------------------------------------------------  ----------
 * 10/08/13  1            LWW       Moved into component-like structure, added SysCVSwitched support
 * 07/31/14  4            BWL       Update per A7131: NTCs 0x02B & 0x036 set on IVER gear causing LoA (C1xx)
 * 12/08/14  5            JWJ       A7716: Patch fix for x36 DMA fault anomaly by adding P/N-step                   12786
 */
...
STATIC VAR(uint16, AUTOMATIC) IoHwAb_SlowADCValidAcc_Cnt_M_u16;
...
STATIC VAR(float32, AUTOMATIC) Vref_Volt_M_f32;
 ...
 *********************************************************************************************************************/
	...
	BattSwitched_Volt_M_f32 = ((float32)BattSwitchedADC_Cnt_T_u16) * D_ADCVOLTSPERCNT_ULS_F32 * D_BATTSWHWSCALING_ULS_F32;
 ...
 *********************************************************************************************************************/
	...
	TemperatureADC_Cnt_T_u16 = DMAData_G_str.SlowADC_Cnt_u16[D_TEMPSNSRCHN_CNT_U16] & D_ADCRESULTMASK_CNT_U16;
	Vref_Cnt_T_u16 = DMAData_G_str.SlowADC_Cnt_u16[D_VREFCHN_CNT_U16] & D_ADCRESULTMASK_CNT_U16;
	...
	if(TRUE == DataValid_Cnt_T_lgc)
	{
		BattSwitched_Volt_M_f32 = ((float32)BattSwitchedADC_Cnt_T_u16) * D_ADCVOLTSPERCNT_ULS_F32 * D_BATTSWHWSCALING_ULS_F32;
		Batt_Volt_M_f32 = ((float32)BattADC_Cnt_T_u16) * D_ADCVOLTSPERCNT_ULS_F32 * D_BATTHWSCALING_ULS_F32;
		SysCVSwitch_Volt_M_f32 = ((float32)SysCVSwitchADC_Cnt_T_u16) * D_ADCVOLTSPERCNT_ULS_F32 * D_BATTSWHWSCALING_ULS_F32;
		Temperature_Volt_M_f32 = ((float32)TemperatureADC_Cnt_T_u16) * D_ADCVOLTSPERCNT_ULS_F32;

		Vref_Volt_M_f32 = (float32)Vref_Cnt_T_u16 * D_ADCVOLTSPERCNT_ULS_F32 * k_ADCVrefScaling_Uls_f32;
		if(Vref_Volt_M_f32 > k_VrefMax_Volts_f32)
		{
		...
		else if(Vref_Volt_M_f32 < k_VrefMin_Volts_f32)
		{
			IoHwAb_ADCVrefErrorAcc_Cnt_M_u16 = DiagPStep_m(IoHwAb_ADCVrefErrorAcc_Cnt_M_u16, k_VrefOORDiag_Cnt_str);
			if (DiagFailed_m( IoHwAb_ADCVrefErrorAcc_Cnt_M_u16, k_VrefOORDiag_Cnt_str) == D_TRUE_CNT_LGC)
			{

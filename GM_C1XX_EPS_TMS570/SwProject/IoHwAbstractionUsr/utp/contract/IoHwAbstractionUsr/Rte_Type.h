...
struct Rte_CDS_IoHwAbstractionUsr
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWABSTRACTIONUSR_APPL_VAR) IoHwAb_Init_BattSwitched_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWABSTRACTIONUSR_APPL_VAR) IoHwAb_Init_Batt_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWABSTRACTIONUSR_APPL_VAR) IoHwAb_Init_SysCVSwitch_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_IOHWABSTRACTIONUSR_APPL_VAR) IoHwAb_Init_TemperatureADC_Volt_f32;
...
extern CONSTP2CONST(struct Rte_CDS_IoHwAbstractionUsr, RTE_CONST, RTE_CONST) Rte_Inst_IoHwAbstractionUsr;
...
#    error "The magic number of the generated file <C:/Synergy/GM_C1XX_EPS_TMS570-zz4r1x1/GM_C1XX_EPS_TMS570/SwProject/IoHwAbstractionUsr/utp/contract/IoHwAbstractionUsr/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

...
struct Rte_CDS_Ap_SrlComInput
{
  ...
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_BusOffCE_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMINPUT_APPL_VAR) SrlComInput_Per2_BusOffHS_Cnt_lgc;
...
#    error "The magic number of the generated file <C:/02_EA3Int/C1xx/Wip_fz9hxm/GM_C1XX_EPS_TMS570/SwProject/SrlComInput/utp/contract/Sa_CDDInterface/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

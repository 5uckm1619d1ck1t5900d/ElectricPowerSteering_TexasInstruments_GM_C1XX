...
struct Rte_CDS_Ap_VehPwrMd
{
  ...
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_SrlComEngOn_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_VEHPWRMD_APPL_VAR) VehPwrMd_Per1_SrlComSPMOn_Cnt_lgc;
...
#    error "The magic number of the generated file <C:/Synergy/GM_K2XX_EPS_TMS570-zz4r1x/GM_K2XX_EPS_TMS570/SwProject/VehPwrMd/utp/contract/Ap_VehPwrMd/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

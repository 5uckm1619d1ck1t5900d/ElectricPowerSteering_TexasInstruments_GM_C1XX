...
..\..\..\Tools\AsrProject\Generators\Rte\dvrtegen -d "..\autosar\%SWC%.dcf" -m %SWC% -g i -o "..\src"  >logfile.txt
..\..\..\Tools\AsrProject\Generators\Rte\dvrtegen -d "..\autosar\%SWC%.dcf" -m %SWC% -g c -o "..\utp\contract" >logfile.txt

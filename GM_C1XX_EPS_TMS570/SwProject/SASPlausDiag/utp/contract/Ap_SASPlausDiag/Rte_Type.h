...
struct Rte_CDS_Ap_SASPlausDiag
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SASPLAUSDIAG_APPL_VAR) SASPlausDiag_Per1_I2CHwAbsPosValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SASPLAUSDIAG_APPL_VAR) SASPlausDiag_Per1_I2CHwAbsPos_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SASPLAUSDIAG_APPL_VAR) SASPlausDiag_Per1_VdAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SASPLAUSDIAG_APPL_VAR) SASPlausDiag_Per1_VdHwPos_HwDeg_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_SASPlausDiag, RTE_CONST, RTE_CONST) Rte_Inst_Ap_SASPlausDiag;
...
#    error "The magic number of the generated file <C:/Workspace/GM_C1XX_Working/C1xx/GM_C1XX_EPS_TMS570/SwProject/SASPlausDiag/utp/contract/Ap_SASPlausDiag/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

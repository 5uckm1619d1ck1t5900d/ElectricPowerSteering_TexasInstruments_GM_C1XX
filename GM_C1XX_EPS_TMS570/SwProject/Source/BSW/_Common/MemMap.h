 ...
 * 06/22/16  31.1.3   CP        Update SF99B MtrCtrl_CM from v12.0 to v18.0                                                  12581
 */
/**********************************************************************************************************************
 * INCLUDES
 *********************************************************************************************************************/
...
#elif defined DFLTCONFIGDATA_START_SEC_VAR_INIT_UNSPECIFIED
	#undef DFLTCONFIGDATA_START_SEC_VAR_INIT_UNSPECIFIED
	#define START_SEC_VAR_INIT_UNSPECIFIED_9

#elif defined DFLTCONFIGDATA_STOP_SEC_VAR_INIT_UNSPECIFIED
	#undef DFLTCONFIGDATA_STOP_SEC_VAR_INIT_UNSPECIFIED
	#define STOP_SEC_VAR
...
#elif defined GCCDIAG_START_SEC_VAR_CLEARED_16
	#undef GCCDIAG_START_SEC_VAR_CLEARED_16
	#define START_SEC_VAR_CLEARED_16_10

#elif defined GCCDIAG_STOP_SEC_VAR_CLEARED_16
	#undef GCCDIAG_STOP_SEC_VAR_CLEARED_16
	#define STOP_SEC_VAR

#elif defined GCCDIAG_START_SEC_VAR_CLEARED_UNSPECIFIED
	#undef GCCDIAG_START_SEC_VAR_CLEARED_UNSPECIFIED
	#define START_SEC_VAR_CLEARED_UNSPECIFIED_10

#elif defined GCCDIAG_STOP_SEC_VAR_CLEARED_UNSPECIFIED
...
#elif defined NHET1_START_SEC_CONST_8
    #undef NHET1_START_SEC_CONST_8
    #define START_SEC_CONST_8BIT

#elif defined NHET1_STOP_SEC_CONST_8
    #undef NHET1_STOP_SEC_CONST_8
    #define STOP_SEC_CONST

#elif defined NHET1_START_SEC_VAR_CLEARED_8
    #undef NHET1_START_SEC_VAR_CLEARED_8
    #define START_SEC_VAR_CLEARED_8_10

#elif defined NHET1_STOP_SEC_VAR_CLEARED_8
    #undef NHET1_STOP_SEC_VAR_CLEARED_8
    #define STOP_SEC_VAR

#elif defined NHET1_START_SEC_VAR_CLEARED_16
    #undef NHET1_START_SEC_VAR_CLEARED_16
    #define START_SEC_VAR_CLEARED_16_10

#elif defined NHET1_STOP_SEC_VAR_CLEARED_16
    #undef NHET1_STOP_SEC_VAR_CLEARED_16
    #define STOP_SEC_VAR

#elif defined NHET1_START_SEC_VAR_CLEARED_32
    #undef NHET1_START_SEC_VAR_CLEARED_32
    #define START_SEC_VAR_CLEARED_32_10

#elif defined NHET1_STOP_SEC_VAR_CLEARED_32
...
/* Variables */
#elif defined SRLCOMINPUT_START_SEC_VAR_INIT_32
    #undef SRLCOMINPUT_START_SEC_VAR_INIT_32
    #define START_SEC_VAR_INIT_32_9

#elif defined SRLCOMINPUT_STOP_SEC_VAR_INIT_32
    #undef SRLCOMINPUT_STOP_SEC_VAR_INIT_32
    #define STOP_SEC_VAR

#elif defined SRLCOMINPUT_START_SEC_VAR_INIT_16
    #undef SRLCOMINPUT_START_SEC_VAR_INIT_16
    #define START_SEC_VAR_INIT_16_9

#elif defined SRLCOMINPUT_STOP_SEC_VAR_INIT_16
    #undef SRLCOMINPUT_STOP_SEC_VAR_INIT_16
    #define STOP_SEC_VAR
...
#elif defined TMPRLMON_START_SEC_VAR_CLEARED_16
	#undef TMPRLMON_START_SEC_VAR_CLEARED_16
	#define START_SEC_VAR_NOINIT_16_10

#elif defined TMPRLMON_STOP_SEC_VAR_CLEARED_16

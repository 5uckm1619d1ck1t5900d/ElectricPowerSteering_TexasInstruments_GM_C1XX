...
#define Rte_NvmBlock_CmMtrCurr_CurrTempOffset (5)
#define Rte_NvmBlock_CmMtrCurr_ShCurrCal (6)
#define Rte_NvmBlock_CurrParamComp_EOLNomMtrParam (7)
#define Rte_NvmBlock_Polarity_Polarity_Cnt_Str (8)
#define Rte_NvmBlock_TrqCmdScl_TorqueCmdSF_Uls_f32 (9)
#define Rte_NvmBlock_BatteryVoltage_OvervoltageData (10)
#define NvM_NVM_BLOCK_DEM_DEPRECATED (11)
#define NVM_BLOCK_DIAGMGR_NTCSTRG (12)
#define NVM_BLOCK_CMS_EPSDEFEATS (13)
#define NVM_BLOCK_SER_VINDATA (14)
#define NVM_BLOCK_SER_SYSTEMNAME (15)
#define NVM_BLOCK_SER_REPAIRSHOPCODE (16)
#define NVM_BLOCK_SER_PROGDATE (17)
#define NVM_BLOCK_SER_SYSVERSCODEDDI (18)
#define NVM_BLOCK_SER_CUSTMEC (19)
#define NVM_BLOCK_SER_MANFTRAC (20)
#define NVM_BLOCK_SER_ENDMODELPN (21)
#define NVM_BLOCK_SER_ENDMODELPNAC (22)
#define NVM_BLOCK_SER_SEED_DEPRECATED (23)
#define NVM_BLOCK_SER_KEY_DEPRECATED (24)
#define NVM_BLOCK_SER_DATAUNIVNUMSYSID (25)
#define NVM_BLOCK_CMS_NXTRWIRSELECT (26)
#define NVM_BLOCK_CMS_NXTRMEC (27)
#define NVM_BLOCK_CMS_ECUSRLNUM (28)
#define NVM_BLOCK_CMS_EPSSRLNUM (29)
#define NVM_BLOCK_CMS_ECUHWPN (30)
#define NVM_BLOCK_CMS_NXTRMANUFSCRATCHPAD (31)
#define NVM_BLOCK_CMS_IGNCNTR (32)
#define NVM_BLOCK_STAMD_TYPEH (33)
#define NVM_BLOCK_STAMD_CLOSECHECK (34)
#define NVM_BLOCK_DIAGMGR_BLACKBOX (35)
#define Rte_NvmBlock_Sa_DigHwTrqSENT_DigTrqTrim (36)
#define Rte_NvmBlock_Sa_DigMSB_DigMSBEOLData (37)
#define NVM_BLOCK_SER_BASEMODELPN (38)
#define NVM_BLOCK_SER_BASEMODELPNAC (39)
#define NVM_BLOCK_SER_CALPRGFLAG (40)
#define Rte_NvmBlock_AbsHwPos_EOLVehCntrOffset (41)
#define Rte_NvmBlock_DigColPs_DigColPsEOL (42)
#define Rte_NvmBlock_Ap_TrqCanc_CogTrqRplComp (43)
#define NVM_BLOCK_SER_PREVREPAIRSHOPCODE (44)
#define Rte_NvmBlock_Ap_AstLmt_SteerAsstDefeat (45)
#define Rte_NvmBlock_Ap_TSMit_TSMitDisableEOL (46)
#define Rte_NvmBlock_Ap_TSMit_TSMitGainLrn (47)
#define NVM_BLOCK_CMS_NXTRMECFLAG (48)
#define NVM_BLOCK_SER_SEED_SPS (49)
#define NVM_BLOCK_SER_KEY_SPS (50)
#define NVM_BLOCK_SER_SEED_CPID (51)
#define NVM_BLOCK_SER_KEY_CPID (52)
#define NVM_BLOCK_SER_SEED_NEXTEER (53)
#define NVM_BLOCK_SER_KEY_NEXTEER (54)
#define Rte_NvmBlock_VehDyn_MotPosReset (55)
#define NVM_BLOCK_SER_ECU_ID (56)
#define NVM_BLOCK_SER_APP_NBID (57)
#define NVM_BLOCK_SER_BCID (58)
#define NVM_BLOCK_SER_SBAT (59)
#define NvM_NVM_BLOCK_DEM (60)
#define Rte_NvmBlock_SrlComOutput_DTCTrigSts (61)
/*</NVM_BLOCK_ID_CFG>*/


/* number of defined NV blocks */
#define NVM_TOTAL_NUM_OF_NVRAM_BLOCKS   /*<NVM_TOTAL_NUM_OF_NVRAM_BLOCKS/>*/ (62u)

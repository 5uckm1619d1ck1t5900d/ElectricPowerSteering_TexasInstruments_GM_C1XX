...
extern VAR(uint8, NVM_APPL_DATA) Nvm_RepairShopCode_Cnt_u8[];
...
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_Sa_DigHwTrqSENT_DigTrqTrim[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_Sa_DigMSB_DigMSBEOLData[];
...
extern VAR(uint8, NVM_APPL_DATA) Nvm_PrevRepairShopCode_Cnt_u8[];
...
#include "MemMap.h"
    ...
    /* block descriptor user block NVM_BLOCK_SER_REPAIRSHOPCODE */
    ,{
        (NvM_RamAddressType)&Nvm_RepairShopCode_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_SEED_DEPRECATED */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block NVM_BLOCK_SER_KEY_DEPRECATED */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_Sa_DigHwTrqSENT_DigTrqTrim */
    ,{
        (NvM_RamAddressType)&NvMP_Rte_Sa_DigHwTrqSENT_DigTrqTrim /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_Sa_DigMSB_DigMSBEOLData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_PREVREPAIRSHOPCODE */
    ,{
        (NvM_RamAddressType)&Nvm_PrevRepairShopCode_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        ...
        1300u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
        NVM_BLOCK_NATIVE,/* Management Type */

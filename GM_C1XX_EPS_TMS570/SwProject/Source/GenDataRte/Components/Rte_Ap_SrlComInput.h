...
extern VAR(Float, RTE_VAR_INIT) Rte_SrlComInput_SrlComLatAccel_g_f32;
...
extern VAR(Float, RTE_VAR_INIT) Rte_SrlComInput_SrlComVehicleLonAccel_KphpS_f32;
...
#  define Rte_IRead_SrlComInput_Per2_BusOffCE_Cnt_lgc() \
  (Rte_Task_10ms_9.Rte_RB.Rte_Ap_SrlComInput_SrlComInput_Per2.Rte_BusOffCE_Cnt_lgc.value)

#  define Rte_IRead_SrlComInput_Per2_BusOffHS_Cnt_lgc() \
  (Rte_Task_10ms_9.Rte_RB.Rte_Ap_SrlComInput_SrlComInput_Per2.Rte_BusOffHS_Cnt_lgc.value)
...
#  define Rte_Read_Ap_SrlComInput_DiagRmpToZeroActive_Cnt_lgc(data) (*(data) = Rte_DiagMgr_DiagRmpToZeroActive_Cnt_lgc, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Write_Ap_SrlComInput_SrlComLatAccel_g_f32(data) (Rte_SrlComInput_SrlComLatAccel_g_f32 = (data), ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Write_Ap_SrlComInput_SrlComVehicleLonAccel_KphpS_f32(data) (Rte_SrlComInput_SrlComVehicleLonAccel_KphpS_f32 = (data), ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Call_SrlComInput_Per2_CP0_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)4, (WdgM_CheckpointIdType)0))
...
#    error "The magic number of the generated file <C:/02_EA3Int/BEV/wip_fz9hxm/GM_C1XX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_SrlComInput.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

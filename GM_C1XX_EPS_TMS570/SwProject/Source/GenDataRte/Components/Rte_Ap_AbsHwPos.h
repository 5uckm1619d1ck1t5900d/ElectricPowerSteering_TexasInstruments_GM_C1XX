 ...
 *   ECU-Project:  EPS
 *  Generated at:  Wed Jun 22 17:08:26 2016
 *
...
extern VAR(UInt8, RTE_VAR_INIT) Rte_Sa_DigMSB_AlignedCumMechMtrPosStatus_Cnt_u08;
...
#  define Rte_IRead_AbsHwPos_Per2_I2CHwAbsPosValid_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_TB.Rte_I_DigColPs_I2CHwAbsPosValid_Cnt_lgc.value)

#  define Rte_IRead_AbsHwPos_Per2_I2CHwAbsPos_HwDeg_f32() \
  (Rte_Task_2ms_10.Rte_TB.Rte_I_DigColPs_I2CHwAbsPos_HwDeg_f32.value)
...
#  define Rte_Read_Ap_AbsHwPos_TurnsCntrValidity_Cnt_u08(data) (*(data) = Rte_Sa_DigMSB_AlignedCumMechMtrPosStatus_Cnt_u08, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Call_EOLVehCntrOffset_GetErrorStatus(arg1) (NvM_GetErrorStatus((NvM_BlockIdType)41, arg1), ((Std_ReturnType)RTE_E_OK))
#  define RTE_START_SEC_NVM_APPL_CODE
#  include "MemMap.h"
...
#  define Rte_Call_EOLVehCntrOffset_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)41, arg1))
...
#    error "The magic number of the generated file <C:/02_EA3Int/BEV/wip_fz9hxm/GM_C1XX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_AbsHwPos.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

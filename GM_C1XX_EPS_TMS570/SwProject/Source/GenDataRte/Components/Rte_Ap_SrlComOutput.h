...
#  define Rte_Read_Ap_SrlComOutput_HwTrq_HwNm_f32(data) (*(data) = Rte_Ap_Sweep_OutputHwTrq_HwNm_f32, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Call_DTCTrigSts_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)61, arg1))
...
#    error "The magic number of the generated file <C:/02_EA3Int/BEV/wip_fz9hxm/GM_C1XX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_SrlComOutput.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

...
#  define Rte_IWrite_DigMSB_Per2_MechMtrPos2_Rev_u0p16(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Sa_DigMSB_MechMtrPos2_Rev_u0p16.value = (data) \
  )

#  define Rte_IWriteRef_DigMSB_Per2_MechMtrPos2_Rev_u0p16() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_Sa_DigMSB_MechMtrPos2_Rev_u0p16.value)
...
#    error "The magic number of the generated file <C:/02_EA3Int/BEV/wip_fz9hxm/GM_C1XX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Sa_DigMSB.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

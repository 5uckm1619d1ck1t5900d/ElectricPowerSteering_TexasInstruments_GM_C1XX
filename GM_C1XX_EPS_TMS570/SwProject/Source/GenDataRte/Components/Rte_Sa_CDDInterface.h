...
#  define Rte_IWrite_CDDInterface_Per1_RxMtrPos1ParityAccum_Cnt_u16(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_CDDInterface_RxMtrPos1ParityAccum_Cnt_u16.value = (data) \
  )
...
#  define Rte_IWrite_CDDInterface_Per1_SysCorrectedElecMtrPos_Rev_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Sa_CDDInterface_CDDInterface_Per1.Rte_SysCorrectedElecMtrPos_Rev_f32.value = (data) \
  )

#  define Rte_IWriteRef_CDDInterface_Per1_SysCorrectedElecMtrPos_Rev_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Sa_CDDInterface_CDDInterface_Per1.Rte_SysCorrectedElecMtrPos_Rev_f32.value)
...
#    error "The magic number of the generated file <C:/02_EA3Int/BEV/wip_fz9hxm/GM_C1XX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Sa_CDDInterface.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

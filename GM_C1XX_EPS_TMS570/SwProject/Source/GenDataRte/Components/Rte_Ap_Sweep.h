...
#  define Rte_IRead_Sweep_Per1_VehSpd_Kph_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_Sweep_Sweep_Per1.Rte_VehSpd_Kph_f32.value)

#  define Rte_IWrite_Sweep_Per1_OutputHwTrq_HwNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_Sweep_Sweep_Per1.Rte_OutputHwTrq_HwNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_Sweep_Per1_OutputHwTrq_HwNm_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_Sweep_Sweep_Per1.Rte_OutputHwTrq_HwNm_f32.value)
...
#    error "The magic number of the generated file <C:/02_EA3Int/BEV/wip_fz9hxm/GM_C1XX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_Sweep.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

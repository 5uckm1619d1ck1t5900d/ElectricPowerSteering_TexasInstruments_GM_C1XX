...
#  define Rte_Call_StaMd_Per1_CP1_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)6, (WdgM_CheckpointIdType)1))
...
FUNC(void, RTE_AP_STAMD_APPL_CODE) Call_StaMd_Init1(void);
...
#    error "The magic number of the generated file <C:/02_EA3Int/BEV/wip_fz9hxm/GM_C1XX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_StaMd.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

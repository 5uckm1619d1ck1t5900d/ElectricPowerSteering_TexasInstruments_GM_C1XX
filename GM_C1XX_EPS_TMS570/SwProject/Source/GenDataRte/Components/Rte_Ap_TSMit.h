...
#  define Rte_Call_TSMitDisableEOL_WriteBlock(arg1) (NvMProxy_WriteBlock((UInt8)13, arg1))
#  define RTE_START_SEC_NVMPROXY_APPL_CODE
#  include "MemMap.h"
...
#  define Rte_Call_TSMitGainLrn_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((UInt8)14, arg1), ((Std_ReturnType)RTE_E_OK))
#  define Rte_Call_TSMitGainLrn_WriteBlock(arg1) (NvMProxy_WriteBlock((UInt8)14, arg1))
...
#    error "The magic number of the generated file <C:/02_EA3Int/BEV/wip_fz9hxm/GM_C1XX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_TSMit.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

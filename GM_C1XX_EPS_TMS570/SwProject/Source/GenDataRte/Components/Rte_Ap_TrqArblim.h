...
#  define Rte_InitValue_GMOSHOscillate_State_enum (1U)
...
#  define Rte_IRead_TrqArblim_Per1_GMOSHOscillate_State_enum() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_TrqArblim_TrqArblim_Per1.Rte_GMOSHOscillate_State_enum.value)
...
#    error "The magic number of the generated file <C:/02_EA3Int/BEV/wip_fz9hxm/GM_C1XX_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_TrqArblim.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

...
Isr_OvervoltThresh_cat2
   stmfd  sp!,{r0,r1,lr}
   stmfd  sp!,{r2,r3,r4,ip}
   mov    r3,#6   ; r3 = ISR ID for Isr_OvervoltThresh
   bl osEnterCallLeaveISR
...
; END OF C:\02_EA3Int\C1xx\Wip_fz9hxm\GM_C1XX_EPS_TMS570\Tools\AsrProject\..\..\SwProject\Source\GenData\\..\GenDataOs\intvect.asm

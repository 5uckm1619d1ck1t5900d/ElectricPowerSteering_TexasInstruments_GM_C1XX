 ...
 *     Workspace:  C:/SynergyWorkArea/CBD_MtrTempEst/MtrTempEst/autosar
 *     SW-C Type:  Ap_MtrTempEst
 *  Generated at:  Mon Oct 22 15:51:34 2012
 *
 ...
 * %version:          20 %
 * %date_modified:    Wed Apr 10 14:29:42 2013 %
 *---------------------------------------------------------------------------------------------------------------------
...
#define D_TEMPESTLOLMT_DEGC_F32				-50.0F
#define D_TEMPESTHILMT_DEGC_F32				150.0F
...
STATIC VAR(LPF32KSV_Str, AP_MTRTEMPEST_VAR_NOINIT) CuAmbLPFiltSV_Watts_M_str;
STATIC VAR(LPF32KSV_Str, AP_MTRTEMPEST_VAR_NOINIT) MagAmbLPFiltSV_Watts_M_str;
STATIC VAR(LPF32KSV_Str, AP_MTRTEMPEST_VAR_NOINIT) SiAmbLPFiltSV_Watts_M_str;
STATIC VAR(LPF32KSV_Str, AP_MTRTEMPEST_VAR_NOINIT) AsstMechLPFiltSV_Watts_M_str;
...
#include "MemMap.h"
STATIC VAR(boolean, AP_MTRTEMPEST_VAR_NOINIT)  AssMechInitComp_Cnt_M_lgc;
STATIC VAR(boolean, AP_MTRTEMPEST_VAR_NOINIT)  PrevScomTempDataRcvd_Cnt_M_lgc;
#define MTRTEMPEST_STOP_SEC_VAR_CLEARED_BOOLEAN
#include "MemMap.h"

#define MTRTEMPEST_START_SEC_VAR_CLEARED_32
#include "MemMap.h"
STATIC VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) CuLLFiltSV_DegC_M_f32;
STATIC VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) MagLLFiltSV_DegC_M_f32;
STATIC VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) SiLLFiltSV_DegC_M_f32;
STATIC VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) AMTempEst_DegC_M_f32;
STATIC VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) AssMechFiltSV_DegC_M_f32;
STATIC VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) AssistMechSlew_DegC_M_f32;

/* Display Variable Test Points */
STATIC volatile VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) AmbPwr_Watts_D_f32;
STATIC volatile VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) ScaledAmbTemp_DegC_D_f32;
STATIC volatile VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) ScaledEngTemp_DegC_D_f32;
STATIC volatile VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) EstMech_Watts_D_f32;
STATIC volatile VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) SiCorr_DegC_D_f32;
STATIC volatile VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) MagCorr_DegC_D_f32;
STATIC volatile VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) CuCorr_DegC_D_f32;
STATIC volatile VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) AMCorr_DegC_D_f32;
STATIC volatile VAR(float32, AP_MTRTEMPEST_VAR_NOINIT) AssistMechFilt_DegC_D_f32;
 ...
 *********************************************************************************************************************/
	...
	LPF_KUpdate_f32_m(k_SiAmbLPFKn_Hz_f32, D_100MS_SEC_F32, &SiAmbLPFiltSV_Watts_M_str);
	LPF_KUpdate_f32_m(k_MagAmbLPFKn_Hz_f32, D_100MS_SEC_F32, &MagAmbLPFiltSV_Watts_M_str);
	LPF_KUpdate_f32_m(k_CuAmbLPFKn_Hz_f32, D_100MS_SEC_F32, &CuAmbLPFiltSV_Watts_M_str);
	LPF_KUpdate_f32_m(k_AMAmbLPFKn_Hz_f32, D_100MS_SEC_F32, &AsstMechLPFiltSV_Watts_M_str);


	AssMechInitComp_Cnt_M_lgc = FALSE;

	AssistMechSlew_DegC_M_f32 = (k_AssistMechSlew_DegCpS_f32 / D_LOOPSPERSEC_CNT_F32);
/**********************************************************************************************************************
 ...
 *   Implicit S/R API:
 *   -----------------
 *   Boolean Rte_IRead_MtrTempEst_Per1_AMTempEstDisable_Cnt_lgc(void)
 ...
 *********************************************************************************************************************/
	...
	AMTempEstDisable_Cnt_T_lgc = Rte_IRead_MtrTempEst_Per1_AMTempEstDisable_Cnt_lgc();
	...
	AmbPwr_Watts_D_f32 = AmbPwr_Watts_T_f32;

	SiAmbPwr_Watts_T_f32 = LPF_OpUpdate_f32_m(AmbPwr_Watts_T_f32, &SiAmbLPFiltSV_Watts_M_str);
	MagAmbPwr_Watts_T_f32 = LPF_OpUpdate_f32_m(AmbPwr_Watts_T_f32, &MagAmbLPFiltSV_Watts_M_str);
	CuAmbPwr_Watts_T_f32 = LPF_OpUpdate_f32_m(AmbPwr_Watts_T_f32, &CuAmbLPFiltSV_Watts_M_str);
	...
	SiCorr_DegC_D_f32 = SiCorr_DegC_T_f32;
	MagCorr_DegC_D_f32 = MagCorr_DegC_T_f32;
	CuCorr_DegC_D_f32 = CuCorr_DegC_T_f32;             											                             							
	...
	SiTempEst_DegC_T_f32 = Limit_m(SiTempEst_DegC_T_f32, D_TEMPESTLOLMT_DEGC_F32, D_TEMPESTHILMT_DEGC_F32);
	MagTempEst_DegC_T_f32 = Limit_m(MagTempEst_DegC_T_f32, D_TEMPESTLOLMT_DEGC_F32, D_TEMPESTHILMT_DEGC_F32);
	CuTempEst_DegC_T_f32 = Limit_m(CuTempEst_DegC_T_f32, D_TEMPESTLOLMT_DEGC_F32, D_TEMPESTHILMT_DEGC_F32);	
	/*STOP- SF06-(FDD name) Temperature Estimation- 
				 (Sub function) Temperature Estimation Subfunction- 
				 (Internal function) Lead/Lag filter func for Motor Circuit Parameter Temperature Estimates(Cfg Option 2) */

	
	if((AssMechInitComp_Cnt_M_lgc == FALSE))
	{ /* Temperature estimation function executes for the first time*/
		...
		{		
				...
				AssMechFiltSV_DegC_M_f32 = (CtrlTempFinal_DegC_T_f32 * (k_AMLLFiltPoleA1_Uls_f32 + k_AMLLFiltCoefB1_Uls_f32)) + (k_TrimTempAM_DegC_f32 * k_AMLLFiltCoefB1_Uls_f32);
		}
		/* Initialise the TempRcvd previous values*/
		AssMechInitComp_Cnt_M_lgc = TRUE;
		PrevScomTempDataRcvd_Cnt_M_lgc = ScomTempDataRcvd_Cnt_T_lgc;
	}
	/* ReInitialise Assist mech LLF based if there is change in ScomTempDataRcvd data received*/
	if ((k_WtAvgTempDFt_Cnt_lgc ==FALSE) &&(PrevScomTempDataRcvd_Cnt_M_lgc != ScomTempDataRcvd_Cnt_T_lgc))
	{
	...
	ScaledAmbTemp_DegC_T_f32 = AmbTemp_DegC_T_f32 * k_AmbTempScl_Uls_f32;
	ScaledAmbTemp_DegC_D_f32 = ScaledAmbTemp_DegC_T_f32;

	ScaledEngTemp_DegC_T_f32 = EngTemp_DegC_T_f32 * k_EngTempScl_Uls_f32;
	ScaledEngTemp_DegC_D_f32 = ScaledEngTemp_DegC_T_f32;
	...
	EstMech_Watts_D_f32 = EstMech_Watts_T_f32;

	AMAmbPwr_Watts_T_f32 = LPF_OpUpdate_f32_m(EstMech_Watts_T_f32, &AsstMechLPFiltSV_Watts_M_str);
	
	AMCorr_DegC_T_f32 = AMAmbPwr_Watts_T_f32 * k_AMAmbMult_DegCpWatt_f32;
	AMCorr_DegC_T_f32 = Limit_m(AMCorr_DegC_T_f32, -k_TempAMEstCorrLmt_DegC_f32, k_TempAMEstCorrLmt_DegC_f32);
	AMCorr_DegC_D_f32 = AMCorr_DegC_T_f32;
	AMTempEst_DegC_T_f32 = AsstMechTemp_DegC_T_f32 + AMCorr_DegC_T_f32;

	AssistMechFilt_DegC_D_f32 = AMTempEst_DegC_T_f32;
	
	AMTempEst_DegC_T_f32 = Limit_m(AMTempEst_DegC_T_f32, 
									(AMTempEst_DegC_M_f32 - AssistMechSlew_DegC_M_f32), 
									(AMTempEst_DegC_M_f32 + AssistMechSlew_DegC_M_f32));
								

	if( TRUE == AMTempEstDisable_Cnt_T_lgc )
	{
		AMTempEst_DegC_T_f32 = k_AMDfltOutoutTemp_DegC_f32;
	}
	/*STOP SF06- (FDD name)Temperature Estimation- 
				 (Sub func) Temperature Estimation Subfucnction- 
				 (Internal Func) Lead/Lag filter func for AssistMehcnaism temp estimation(Cfg Option 1) **********************/	
				   
	AMTempEst_DegC_M_f32 = Limit_m(AMTempEst_DegC_T_f32, D_AMTEMPESTLOLMT_DEGC_F32, D_AMTEMPESTHILMT_DEGC_F32);
	
	PrevScomTempDataRcvd_Cnt_M_lgc = ScomTempDataRcvd_Cnt_T_lgc;
	Rte_IWrite_MtrTempEst_Per1_AssistMechTempEst_DegC_f32(AMTempEst_DegC_M_f32);
...
STATIC FUNC(void, AP_MTRTEMPEST_CODE) LeadLagFiltInit(VAR(float32, AUTOMATIC) CtrlTempFinal_DegC_T_f32,
									...
									VAR(float32, AUTOMATIC) EngTemp_DegC_T_f32)
{
	SiLLFiltSV_DegC_M_f32 = (CtrlTempFinal_DegC_T_f32 * (k_SiLLFiltKA1_Uls_f32 + k_SiLLFiltKB1_Uls_f32)) + (k_TrimTempSi_DegC_f32 * k_SiLLFiltKB1_Uls_f32);
	MagLLFiltSV_DegC_M_f32 = (CtrlTempFinal_DegC_T_f32 * (k_MagLLFiltKA1_Uls_f32 + k_MagLLFiltKB1_Uls_f32)) + (k_TrimTempMag_DegC_f32 * k_MagLLFiltKB1_Uls_f32);
	CuLLFiltSV_DegC_M_f32 = (CtrlTempFinal_DegC_T_f32 * (k_CuLLFiltKA1_Uls_f32 + k_CuLLFiltKB1_Uls_f32)) + (k_TrimTempCu_DegC_f32 * k_CuLLFiltKB1_Uls_f32);
	AssMechFiltInit(AmbTemp_DegC_T_f32, EngTemp_DegC_T_f32);
}
									...
									VAR(float32, AUTOMATIC) EngTemp_DegC_T_f32)
{
	...
	ScaledAmbTemp_DegC_T_f32 = AmbTemp_DegC_T_f32 * k_AmbTempScl_Uls_f32;
	ScaledEngTemp_DegC_T_f32 = EngTemp_DegC_T_f32 * k_EngTempScl_Uls_f32;
	AssMechFiltSV_DegC_M_f32 = ScaledAmbTemp_DegC_T_f32 + ScaledEngTemp_DegC_T_f32;
	AssMechFiltSV_DegC_M_f32 = (AssMechFiltSV_DegC_M_f32 * (k_AMLLFiltPoleA1_Uls_f32 + k_AMLLFiltCoefB1_Uls_f32)) + (k_TrimTempAM_DegC_f32 * k_AMLLFiltCoefB1_Uls_f32);
}

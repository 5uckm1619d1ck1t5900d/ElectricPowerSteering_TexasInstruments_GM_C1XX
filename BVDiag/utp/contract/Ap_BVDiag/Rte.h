...
#    error "The magic number of the generated file <C:/SynergyWorkArea/CBD_BVDiag/BVDiag/utp/contract/Ap_BVDiag/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

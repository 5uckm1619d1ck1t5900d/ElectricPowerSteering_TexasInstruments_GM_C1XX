...
struct Rte_CDS_Ap_TSMit
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_HandwheelAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_HandwheelPosition_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_HandwheelVelocity_HwRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_PreLimitMtrTrqCmd_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_SrlComABSActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_SrlComESCActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_SrlComTCSActive_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_SrlComTransmissionTrq_TransNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_SrlComYawRate_DegpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_TSMitCommand_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_TSMitDefeat_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_TSMitLearningEnabled_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TSMIT_APPL_VAR) TSMit_Per1_VehicleSpeed_Kph_f32;
  /* PIM Handles section */
  P2VAR(TSMit_Disable_Type, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_TSMitDisableEOL;
  P2VAR(TSMit_Gain_Type, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_TSMitGainLrn;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_TSMit, RTE_CONST, RTE_CONST) Rte_Inst_Ap_TSMit;
...
#    error "The magic number of the generated file <C:/Workspace/SF47_TSMit_Implementation-CBD_TSMit/SF47/SF47_TSMit_Implementation/tools/contract/Ap_TSMit/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

...
STATIC FUNC(void, AP_CurrCmd_VAR_NOINIT) LoaMtgtnSclFac( VAR(boolean, AUTOMATIC) MotCurrLoaMtgtnEn_Cnt_T_lgc, VAR(boolean, AUTOMATIC) IvtrLoaMtgtnEn_Cnt_T_lgc );
...
FUNC(void, PICurrCntrl_CODE) PICurrCntrl_Per1(void)
{
	...
	(void)LoaMtgtnSclFac(MotCurrLoaMtgtnEn_Cnt_T_lgc,IvtrLoaMtgtnEn_Cnt_T_lgc);

	/********QAxisVoltageSummation**********************/
	LOAFailSclFacBuff_Uls_T_f32 =  PICurrCntrl_CurrSensFailSclFac_Uls_M_f32 * PICurrCntrl_InverterFailSclFac_Uls_M_f32;

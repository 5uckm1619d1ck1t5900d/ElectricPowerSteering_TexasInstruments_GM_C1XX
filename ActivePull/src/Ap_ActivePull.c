 ...
 * %version:          11 %
 * %derived_by:       czgng4 %
 * %date_modified:    Thu Oct 18 11:34:34 2012 %
 *---------------------------------------------------------------------------------------------------------------------
 ...
 *********************************************************************************************************************/
	...
	{
		Rte_Call_SystemTime_GetSystemTime_mS_u32(&EnableTime_mS_M_u32);
	}
	
	Rte_Call_SystemTime_DtrmnElapsedTime_mS_u32(EnableTime_mS_M_u32, &ElapsedTime_mS_T_u32);
	...
	{
		Rte_Call_SystemTime_GetSystemTime_mS_u32(&STOppSignTime_mS_M_u32);
	}
	
	Rte_Call_SystemTime_DtrmnElapsedTime_mS_u32(STOppSignTime_mS_M_u32, &ElapsedTime_mS_T_u32);
